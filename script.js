...
document.querySelectorAll(".card").forEach(c=>c.addEventListener("click",()=>{
 document.querySelectorAll(".card").forEach(x=>x.classList.remove("active"));c.classList.add("active");
 const d=data[c.dataset.service],box=document.querySelector("#detail");
...
document.querySelector("#contact-form").addEventListener("submit",e=>{
 e.preventDefault();document.querySelector("#form-note").textContent="Formulario de demostración. Añade el endpoint de Formspree en action para recibir solicitudes.";
});
